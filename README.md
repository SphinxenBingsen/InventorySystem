...
I then close the program and open it again and it has kept the information, that I already have processed that order. LLM is used to explain the tasks where to input code, generate suggestions, and spare with.
